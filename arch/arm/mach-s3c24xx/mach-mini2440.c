...
static struct mtd_partition mini2440_default_nand_part[] __initdata = {
	...
	[4] = {
		.name	= "cache",
		.size	= SZ_8M + SZ_2M,
		.offset	= SZ_32M + SZ_2M + SZ_1M + SZ_256K + SZ_128K,
	},
	[5] = {
		.name	= "userdata",
		.size	= MTDPART_SIZ_FULL,
		.offset	= SZ_32M + SZ_8M + SZ_4M + SZ_1M + SZ_256K + SZ_128K,
	},
};
...
static struct hidg_func_descriptor mini2440_hid_data = {
...
static struct platform_device mini2440_hid = {
	.name			= "hidg",
	.id			= 0,
	.num_resources		= 0,
	.resource		= 0,
	.dev.platform_data	= &mini2440_hid_data,
};
